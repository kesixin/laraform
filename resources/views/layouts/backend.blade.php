...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('backend/' )}}" class="logo">
            ...
            <span class="logo-mini"><b>分享</b>社区</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>分享</b>&nbsp;社区</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="" class="img-circle" alt="User Image" style="width: 100%;height: 45px;">
                </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Powered by <a href="{{env('APP_URL')}}" target="_blank">Mamba</a></strong>
    </footer>
</div>
<!-- ./wrapper -->
